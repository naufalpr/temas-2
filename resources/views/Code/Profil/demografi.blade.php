...
<html lang="en">
  <head>
    ...
    <title>Demografi | Kelurahan Temas</title>
  ...
  <body>
    ...
    <div class="container mt-5 text-center">
      <h1 class="mb-4">Demografi Kelurahan Temas</h1>
      <img src="../../Assets/Demografi Penduduk.jpg" class="img-fluid" alt="peta-rw" />
    </div>

    <div class="container mt-5" style="width: 43%">
      <p class="text-center">Penduduk Kelurahan Temas pada bulan Juni 2022 jumlahnya sudah mencapai 17.798 jiwa, Jumlah penduduk laki-laki 8.972 jumlah penduduk perempuan 8.826 jiwa, dari 5780 KK yang ada.</p>
    </div>
    ...
    <section>
      <div class="container">
        <div class="row text-center mt-5">
          <div class="col">
            <th>Jumlah Penduduk Menurut Wilayah RW</th>
          </div>
        </div>
    ...
    <section>
      <div class="container">
        <div class="row text-center mt-5">
          <div class="col">
            <th>Jumlah Penduduk Menurut Tingkat Pendidikan</th>
          </div>
        </div>
        <div class="row mt-2 justify-content-center">
          <div class="col-lg-6">
    ...
    <section>
      <div class="container">
        <div class="row text-center mt-5">
          <div class="col">
            <th>Jumlah Penduduk Menurut Pekerjaan</th>
          </div>
        </div>
        <div class="row mt-2 justify-content-center">
          <div class="col-lg-6">
            <table class="table table-bordered border-black">
              <tbody>
                ...
                <tr>
                  <td>44</td>
                  <td>Anggota DPRD Kota / Kabupaten</td>
                  <td>1</td>
                  <td>0,01%</td>
                </tr>
                <tr>
