    ...
    <main class="container mt-5">
      <div class="row justify-content-center">
        <div class="col-md-8">
          ...
          <img style="max-height: 500px; max-width:800px; overflow:hidden" src="{{ asset('storage/' . $announcement->image) }}" alt="" class="image-fluid me-3">
          <article class="my-3 fs-6">
            <p>{!! $announcement->body !!}</p>
          </article>
          <a href="/pengumuman">< Kembali ke Pengumuman</a>
        </div>
      </div>
    </main>
