...
<html lang="en">
  ...
  <body>
    ...
    <h2 style="text-align: center; margin: 30px 0 -20px 0;">Galeri</h2>
    <h4></h4>
    ...
    <div class="container my-5">
      <div class="row mb-4 gx-3 gy-3">
        ...
        <div class="col-md-3">
          <div class="card">
            <img src="{{ asset('storage/' . $gallery->image) }}" class="card-img-top rounded" alt="galeri1" style="max-height: 200px; min-height: 200px;"/>
          </div>
        </div>
        @endforeach
      </div>
    ...
    <script src="../../js/fetch_galeri.js"></script>
  </body>
</html>
