...
<html lang="en">
  <head>
    ...
    <title>PKK | Kelurahan Temas</title>
  ...
  <body>
    ...
    <div class="container mt-5">
      <div class="row">
        <div class="col-md-8">
          <h5 class="mb-4">PKK (Pemberdayaan Kesejahteraan Keluarga)</h5>
          <p>Gerakan Pemberdayaan dan Kesejahteraan Keluarga yang selanjutnya disebut PKK merupakan salah satu wadah untuk menggerakkan masyarakat dalam pembangunan dimana wanita sebagai motor penggeraknya.</p>
          <p>Dalam perkembangan dan keberadaan PKK melalui Visi dan Misinya masih sangat dominan untuk tetap dipertahankan keberadaannya sesuai dengan kebutuhan mendasar masyarakat yang ada baik di perkantoran maupun di pedesaan.</p>
          <p>
            Pemberdayaan dan Kesejahteraan Keluarga (PKK) yang merupakan gerakan nasional untuk pembangunan keluarga, berazaskan Pancasila dan UUD 1945 dan bertaqwa kepada Tuhan Yang Maha Esa, melakukan kegiatan yang terus menerus dan
            berkesinambungan untuk menghimpun, menggerakan dan membina masyarakat dengan melaksanakan 10 Program Pokok PKK dengan sasaran keluarga sebagai unit terkecil dalam masyarakat untuk mewujudkan keluarga sejahtera yang selalu hidup
            dalam suasana damai, aman, tertib, tenteram, makmur dan sejahtera dalam rangka Ketahanan Nasional.
          </p>
        </div>
        <div class="col-md-2 mx-auto my-auto">
          <img src="../../Assets/logo-pkk.png" class="img-fluid" alt="logo-pkk" />
        </div>
      </div>
    </div>
