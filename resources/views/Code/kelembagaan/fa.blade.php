...
<html lang="en">
  <head>
    ...
    <title>Forum Anak | Kelurahan Temas</title>
  ...
  <body>
    ...
    <nav class="container mt-0" style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
      <ul class="breadcrumb py-1" >
          ...
          <li class="breadcrumb-item">Forum Anak</li>
      </ul>
    </nav>
    ...
    <div class="container mt-5">
      <div class="row">
        <div class="col-md-8">
          <h5 class="mb-4">FA (Forum Anak)</h5>
          <p>
            Sebuah organisasi anak tingkat Kelurahan yang terbentuk sebagai wadah partisipasi anak yang dikelola oleh anak- anak sebagai media untuk mendengar dan memenuhi aspirasi, suara, pendapat, keinginan dan kebutuhan anak dalam proses
            pembangunan serta memperjuangkan hak- hak Anak dan tempat menyalurkan aspirasi anak dibawah naungan Tim Penggerak PKK yang bertugas memfasilitasi, menjaring aspirasi dan mengkoordinasikan pemenuhan hak anak kepada Pemerintah
            Desa / Kelurahan.
          </p>
        </div>
        <div class="col-md-2 mx-auto my-auto">
          <img src="../../Assets/logo-forum-anak.png" class="img-fluid" alt="logo-forum-anak" />
        </div>
      </div>
    </div>
