...
<html lang="en">
  <head>
    ...
    <title>Linmas | Kelurahan Temas</title>
  ...
  <body>
    ...
    <nav class="container mt-0" style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
      <ul class="breadcrumb py-1" >
          ...
          <li class="breadcrumb-item">Linmas</li>
      </ul>
    </nav>
    ...
    <div class="container mt-5">
      <div class="row">
        <div class="col-md-8">
          <h5 class="mb-4">Linmas (Perlindungan Masyarakat)</h5>
          <p>
            Menurut Peraturan Menteri Dalam Negeri Republik Indonesia Nomor 11 Tahun 2023 Tentang Sarana Dan Prasarana Bagi Satuan Tugas Pelindungan Masyarakat Dan Satuan Pelindungan Masyarakat Pelindungan Masyarakat yang selanjutnya
            disebut Linmas adalah segenap upaya dan kegiatan yang dilakukan dalam rangka melindungi masyarakat dari gangguan yang diakibatkan oleh bencana serta upaya untuk melaksanakan tugas membantu penanganan bencana guna mengurangi dan
            memperkecil akibat bencana, membantu memelihara keamanan, ketenteraman dan ketertiban masyarakat, membantu kegiatan social kemasyarakatan, membantu memelihara ketenteraman dan ketertiban pada saat pemilihan kepala Desa,
            pemilihan kepala daerah, dan pemilihan umum, serta membantu upaya pertahanan negara.
          </p>
          <p>
            ...
            Anggota Satlinmas adalah warga negara Indonesia yang memenuhi persyaratan dan secara sukarela turut serta dalam kegiatan Linmas.
          </p>
          <p>
            Di kelurahan Temas berjumlah 120 anggota linmas yang tersebar di 11 rw. yang tugasnya membantu menjaga keamanan lingkungan, masing-masing regu juga dilengkapi dengan peralatan komunikasi berupa HT (Handy Talky) Jumlah pos
            kamling ada 40 tersebar di wilayah RT.
          </p>
        </div>
        <div class="col-md-2 mx-auto my-auto">
          <img src="../../Assets/logo-linmas.png" class="img-fluid" alt="logo-linmas" />
        </div>
      </div>
    </div>
