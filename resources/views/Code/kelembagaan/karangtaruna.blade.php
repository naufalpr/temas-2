...
<html lang="en">
  <head>
    ...
    <title>Karang Taruna | Kelurahan Temas</title>
  ...
  <body>
    ...
    <nav class="container mt-0" style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
      <ul class="breadcrumb py-1" >
          ...
          <li class="breadcrumb-item">Karang Taruna</li>
      </ul>
    </nav>
    ...
    <div class="container mt-5">
      <div class="row">
        <div class="col-md-8">
          <h5 class="mb-4">Karang Taruna</h5>
          <p>
            Karang Taruna adalah organisasi kepemudaan di Indonesia yang dibentuk oleh masyarakat sebagai wadah generasi muda untuk mengembangkan diri, tumbuh, dan berkembang atas dasar kesadaran serta tanggung jawab sosial dari, oleh, dan
            untuk generasi muda, yang berorientasi pada tercapainya kesejahteraan sosial bagi masyarakat.
          </p>
          <p>
            Sebagai organisasi sosial kepemudaan Karang Taruna merupakan wadah pembinaan dan pengembangan serta pemberdayaan dalam upaya mengembangkan kegiatan ekonomi produktif dengan pendayagunaan semua potensi yang tersedia di lingkungan
            baik sumber daya manusia maupun sumber daya alam yang telah ada. Sebagai organisasi kepemudaan, Karang Taruna berpedoman pada Pedoman Dasar dan Pedoman Rumah Tangga di mana telah pula diatur tentang struktur pengurus dan masa
            jabatan di masing-masing wilayah mulai dari Desa/ Kelurahan sampai pada tingkat Nasional. Semua ini wujud dari pada regenerasi organisasi demi kelanjutan organisasi serta pembinaan anggota Karang Taruna baik dimasa sekarang
            maupun masa yang akan datang.
          </p>
          <p>
            Karang Taruna beranggotakan pemuda dan pemudi Anggota Karang Taruna yang selanjutnya disebut Warga Karang Taruna adalah setiap anggota masyarakat yang berusia 13 (tiga belas) tahun sampai dengan 45 (empat puluh lima) tahun yang
            berada di desa/kelurahan. Karang Taruna berkedudukan di desa/kelurahan di dalam wilayah hukum Negara Kesatuan Republik Indonesia dan batasan sebagai Pengurus adalah berusia mulai 17 - 35 tahun.
          </p>
          <p>Karang Taruna didirikan dengan visi-misi tujuan memberikan pembinaan dan pemberdayaan kepada para remaja, misalnya dalam bidang keorganisasian, ekonomi, olahraga, ketrampilan, advokasi, keagamaan dan kesenian.</p>
        </div>
        <div class="col-md-2 mx-auto my-auto">
          <img src="../../Assets/logo-karang-taruna.png" class="img-fluid" alt="logo-karang-taruna" />
        </div>
      </div>
    </div>
