...
<html lang="en">
  <head>
    ...
    <title>POKDARWIS | Kelurahan Temas</title>
  ...
  <body>
    ...
    <div class="container mt-5">
      <div class="row">
        <div class="col-md-8">
          <h5 class="mb-4">POKDARWIS (Kelompok Sadar Wisata)</h5>
          <p>
            Gerakan Sadar Wisata tersebut diwujudkan melalui adanya Kelompok Sadar Wisata (Pokdarwis) yang menjadi aktor penggerak kepariwisataan desa. Keberadaan Pokdarwis sebagai suatu institusi lokal terdiri atas para pelaku
            kepariwisataan yang memiliki kepedulian dan tanggung jawab untuk menjamin pelaksanaan desa wisata.
          </p>
          <p>
            Secara umum, fungsi Pokdarwis dalam kegiatan kepariwisataan adalah, sebagai penggerak Sadar Wisata dan Sapta Pesona di lingkungan wilayah di destinasi wisata, serta menjadi mitra pemerintah pusat dan pemerintah daerah kabupaten
            maupun kota dalam upaya perwujudan dan pengembangan Sadar Wisata di daerah.
          </p>
          <p>
            Dalam mensukseskannya tidak terlepas dari konsep pentahelix pariwisata yang merupakan gabungan dari 5 unsur pariwisata. Unsur-unsur yang saling berkesinambungan dalam pembangunan pariwisata yaitu Pemerintah, Akademisi,
            Komunitas, Pengusaha dan Media.
          </p>
          <p>
            Masyarakat Sadar Wisata memiliki peranan penting dalam mewujudkan Sapta Pesona dengan mengembangkan desa wisata mulai dari memanfaatkan potensi wisata, menciptakan produk-produk untuk peluang usaha wisata, membangun fasilitas
            umum pada tempat-tempat wisata, hingga mengembangkan sumber daya alam dan sumber daya manusia pada daerah wisata.
          </p>
        </div>
        <div class="col-md-2 mx-auto my-auto">
          <img src="../../Assets/logo-pokdarwis.png" class="img-fluid" alt="logo-pokdarwis" />
        </div>
      </div>
    </div>
