...
<html lang="en">
  <head>
    ...
    <title>LPMK | Kelurahan Temas</title>
  ...
  <body>
    ...
    <nav class="container mt-0" style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
      <ul class="breadcrumb py-1" >
          ...
          <li class="breadcrumb-item">LPMK</li>
      </ul>
    </nav>
    ...
    <div class="container mt-5">
      <div class="row">
        <div class="col-md-8">
          <h5 class="mb-4">LPMK (Lembaga Pemberdayaan Masyarakat Kelurahan)</h5>
          <p>
            Lembaga Pemberdayaan Masyarakat Kelurahan yang selanjutnya disingkat LPMK adalah Lembaga Kemasyarakatan Kelurahan yang dibentuk atas prakarsa masyarakat sebagai mitra kelurahan dalam menampung dan mewujudkan aspirasi dan
            kebutuhan masyarakat di bidang pembangunan.
          </p>
          <p>LPMK mempunyai tugas membantu Pemerintah Kelurahan / Lurah dalam pelaksanaan urusan pemerintahan, pembangunan, sosial kemasyarakatan, dan pemberdayaan masyarakat.</p>
        </div>
        <div class="col-md-2 mx-auto">
          <img src="../../Assets/logo-lpmk.jpg" class="img-fluid" alt="logo-lpmk" />
        </div>
      </div>
    </div>
