...
<html lang="en"> 
  <head>
    ...
    <title>BKM | Kelurahan Temas</title>
  ...
  <body>
    ...
    <div class="container mt-5">
      <div class="row">
        <div class="col-md-8">
          <h5 class="mb-4">BKM (Badan Keswadayaan Masyarakat)</h5>
          <p>
            Lembaga mitra Kelurahan yang berfungsi sebagai pelaksana Program pemberdayaan masyarakat dalam Program Pengentasan kemiskinan, di dalam lembaga ini juga ada unit-unit pengelola yaitu upk unit pengelola keuangan yang tugasnya
            adalah mengoparasionalkan dana bantuan kusunya dibidang simpan pinjam, UPS unit pengelola sosial yang tugasnya mengelola dana bantuan dibidang sosial seperti pelatihan pelatihan ketrampilan, UPL unit pengelola lingkungan yang
            tugasnya membuat proposal pengajuan, pelaporan, dan mengawasi pelaksanaan bangunan fisik. BKM Temas beranggotakan 11 orang anggota, 1 orang sekretaris 3 orang upk.
          </p>
        </div>
        <div class="col-md-2 mx-auto my-auto">
          <img src="../../Assets/logo-bkm.png" class="img-fluid" alt="logo-bkm" />
        </div>
      </div>
    </div>
