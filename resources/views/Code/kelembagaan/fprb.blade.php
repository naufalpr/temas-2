...
<html lang="en">
  <head>
    ...
    <title>FPRB | Kelurahan Temas</title>
  ...
  <body>
    ...
    <nav class="container mt-0" style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
      <ul class="breadcrumb py-1" >
          ...
          <li class="breadcrumb-item">FPRB</li>
      </ul>
    </nav>
    ...
    <div class="container mt-5">
      <div class="row">
        <div class="col-md-8">
          <h5 class="mb-4">FPRB (Forum Pengurangan Risiko Bencana)</h5>
          <p>
            FPRB adalah platform untuk koordinasi dan kolaborasi para pemangku kepentingan dalam mendukung upaya-upaya pengurangan risiko bencana. Koordinasi ini perlu perlu diwujudkan dengan kerjasama antar lembaga yang efektif dan
            ditujukan untuk bersama-sama membangun daerah berbasis pengurangan risiko bencana.
          </p>
          <p>
            Sebagaimana tercantum dalam Peraturan Pemerintah Nomor 21 Tahun 2008, FPRB merupakan salah satu rencana aksi daerah yang meliputi unsur pemerintah daerah, non-pemerintah, masyarakat, dunia usaha, akademisi, dan media yang
            dikoordinasikan oleh BPBD dalam pelaksanaan pengurangan risiko bencana.
          </p>
          <p>
            Contoh kegiatannya antara lain membuat peta wilayah rawan bencana, pembuatan bangunan tahan gempa, penanaman pohon bakau, penghijauan hutan, serta memberikan penyuluhan dan meningkatkan kesadaran masyarakat yang tinggal di
            wilayah rawan bencana.
          </p>
        </div>
        <div class="col-md-2 mx-auto my-auto">
          <img src="../../Assets/logo-fprb.png" class="img-fluid" alt="logo-fprb" />
        </div>
      </div>
    </div>
