...
<html lang="en">
  <head>
    ...
    <title>KIM | Kelurahan Temas</title>
  ...
  <body>
    ...
    <nav class="container mt-0" style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
      <ul class="breadcrumb py-1" >
          ...
          <li class="breadcrumb-item">KIM</li>
      </ul>
    </nav>
    ...
    <div class="container mt-5">
      <div class="row">
        <div class="col-md-8">
          <h5 class="mb-4">KIM (Kelompok Informasi Masyarakat)</h5>
          <p>
            KIM sebagai komunitas masyarakat informasi yang tumbuh dan berkembang di tengah – tengah kehidupan masyarakat khususnya di Indonesia merupakan masyarakat sadar informasi yang diharapkan dapat berperan menjadi fasilitator untuk
            menjembatani kesenjangan komunikasi dan informasi yang terjadi antara pemerintah dengan masyarakat (top down) atau sebaliknya antara masyarakat dan pemerintah (bottom up).
          </p>
          <p>
            KIM TEMAS BAHTERA Yang ada di Kelurahan Temas lebih mengutamakan di bidang informasi terhadap masyarakat sebab bidang pemberdayaan sudah banyak lembaga yang menanganinya. Masyarakat temas lebih membutuhkan informasi tentang
            program Pemerintah yang selama ini tidak begitu sampai pada masyarakat kalangan bawah.
          </p>
          <p>
            Maka KIM TEMAS BAHTERA berusaha menjembatani antara pemerintah dengan masyarakat. Kegiatan KIM TEMAS BAHTERA sering dilakukan adalah sosialisasi –sosialisasi tentang berbagai hal program yang masyarakat sangat membutuhkan dan
            menyampaikan aspirasi masyarakat yang bersifat membangun. Juga penyampaian hasil pembangunan yang ada di Kelurahan Temas. Baik dari dinas maupun dari swadaya murni masyarakat.
          </p>
        </div>
        <div class="col-md-2 mx-auto my-auto">
          <img src="../../Assets/logo-kim.png" class="img-fluid" alt="logo-kim" />
        </div>
      </div>
    </div>
