...
<html lang="en">
  <head>
    ...
    <title>Tempat Wisata | Kelurahan Temas</title>
  ...
  <body>
    ...
    <h2 style="text-align: center; margin: 30px 0 -20px 0;">Sarana Prasarana</h2>
    <h4></h4>
    ...
    <div class="container my-5">
      <div class="row mb-4 gx-3 gy-3">
        ...
        <div class="col-md-4">
          <div class="card">
            <img src="Assets/kamar_standar_1.jpg" class="card-img-top" alt="sanitasi" style="max-height: 200px; min-height: 200px;"/>
            <div class="card-body">
              <p class="card-title" style="font-family: 'Poppins', sans-serif; text-align: center;">SANITASI</p>
              <!-- <a href="#" class="btn btn-primary btn-sm">Detail</a> -->
            </div>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="card">
            <img src="Assets/kamar_standar_1.jpg" class="card-img-top" alt="telepon internet" style="max-height: 200px; min-height: 200px;"/>
            <div class="card-body">
              <p class="card-title" style="font-family: 'Poppins', sans-serif; text-align: center;">JARINGAN TELEPON DAN INTERNET</p>
              <!-- <a href="#" class="btn btn-primary btn-sm">Detail</a> -->
            </div>
          </div>
        </div>
