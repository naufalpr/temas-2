<div class="sidebar border border-right col-md-3 col-lg-2 p-0 bg-body-tertiary position-fixed" style="height: 100%">
        ...
        <ul class="nav flex-column">
          ...
          <li class="nav-item">
            <a class="nav-link {{ Request::is('dashboard/announcement*') ? 'active' : '' }} d-flex align-items-center gap-2" href="/dashboard/announcement">
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-megaphone text-dark" viewBox="0 0 16 16">
          ...
          <li class="nav-item">
            <a class="nav-link {{ Request::is('dashboard/gallery*') ? 'active' : '' }} d-flex align-items-center gap-2" href="/dashboard/gallery">
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-images text-dark" viewBox="0 0 16 16">
          ...
          <li class="nav-item">
            <a class="nav-link {{ Request::is('dashboard/agenda*') ? 'active' : '' }} d-flex align-items-center gap-2" href="/dashboard/agenda">
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-calendar-event text-dark" viewBox="0 0 16 16">
          ...
          <li class="nav-item">
            <form action="/logout" method="post">
              ...
              <button type="submit" class="nav-link d-flex align-items-center gap-2">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-box-arrow-left text-dark" viewBox="0 0 16 16">
